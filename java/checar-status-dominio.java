...
public class mailgridDomainCheck {
	public static void main(String[] args) {
		// Definindo a URL do endpoint da API
		String url = "https://api.mailgrid.net.br/domain/check/";

		// Dados de autenticação e domínio a ser verificado
		String tokenAuth = "SEU_TOKEN_AQUI"; // Substitua pelo seu token de autenticação
